...
export const metadata: Metadata = {
  title: 'Ignacio Armand-ugón',
  description: 'Pagina personal de Ignacio Armand-ugón',
};
export default function Home() {
  return (
    <main>
      <div id='home' className='flex min-h-screen flex-col items-center justify-between mx-auto md:px-12 overflow-x-hidden max-w-[1400px]' >
        ...
        <Section id='experience'>
          ...
          <Experience
            title='Tafitech'
            description='Está fue una experiencia muy buena'
            technologies={['React', 'Typescript', 'NextJS', 'Jest']}
            startDate='oct 2023'
            endDate='presente'
            role='Consultor de desarrollo Frontend'
          />
